...
let n = [" 王子 ", " hehezhou ", " mayiyang ", "叉义叉", "小跳蛙", "卷王", "颓怪", " ZK ", "高质量好题", "世界", "人们", "现实", "小丑", " NOI ", " NOIp "];
let suj = [" 王子 ", " hehezhou ", " mayiyang ", "叉义叉", "小跳蛙", "卷王", "颓怪", " ZK ", "人们", "现实", "小丑"];
let obj = n;
let vt = ["击杀", "愚弄", "怒斥", "畏惧", "阿鲁巴", "膜拜", "是", "乳", "爆切", " AK ", "歌颂", "控制", "模仿", "吊打", "成为", "反对", "支持", "激烈反对", "尽情嘲笑着"];
let linkv = ["是", "不再是", "早已是"];
let vi = ["内卷", "不行", "复辟", "爬", "爬来爬去", "女装", "乳叉", "搞笑", "流泪", "叹息", "欢呼", "爬", "怪叫", "内卷", "颓废", "忏悔", "在拉莱耶沉睡", "嘬题"];
let vc = ["的不行", "的无知", "的过于强大", "的过于内卷", "的毫无素质"];
let adj = ["不太行的", "巨大的", "小", "丧失理智的", "变态的", "可怜的", "邪恶的", "善良的", "无敌的", "搞笑的", "卷疯了的", "伟大的", "神圣的", "奇怪的", "奇异的", "恐怖的", "不可名状的", "经常容易在竞赛中出现这样那样问题的"];
let adv = ["迷惑地", "狂笑着", "堂而皇之地", "迅速地", "狂怒地", "不得不", "冷静地", "沉着地", "谨慎地"];
let short_sent = ["%a%s%b%v%a%o", "%a%s%b%w"]; // %g
let last_form = ["%g", "%s钦定%g", "%a%s%l%a%o", "%o被%s%b%v"]; // %L
let small_form = ["%L"]; // %f
let form = [
    "%f。",
    "但是，",
